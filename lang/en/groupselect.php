...
$string['studentcancreate_help'] = 'If set, participants without group (in selected grouping) can create groups.';
$string['studentcanleave'] = 'Participants can leave groups';
$string['studentcanleave_help'] = 'If set, participants can leave groups.';
$string['studentcanjoin'] = 'Participants can join groups';
$string['studentcanjoin_help'] = 'If set, participants can join groups';
